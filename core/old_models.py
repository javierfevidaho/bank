...
class Ticket(models.Model):
    ...
    numbers = models.CharField(max_length=20)
    bonus = models.IntegerField()
    purchase_date = models.DateTimeField(auto_now_add=True)  # Fecha de compra del ticket
    draw_date = models.DateField(null=True, blank=True)  # Fecha del sorteo al que pertenece el ticket
